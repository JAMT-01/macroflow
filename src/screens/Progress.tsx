...
export function Progress({ settings, refresh, onSettings }: { settings: Settings; refresh: number; onSettings: (settings: Settings) => void }) {
  ...
  return (
    <div className="page progress-page">
      <header className="page-header"><div><h1>Your progress</h1><p className="page-subtitle">Look for patterns, not perfect days.</p></div><div className="streak-pill"><Flame size={18} /> <strong>{streak}</strong> day streak</div></header>
      ...
      <section className="chart-card">
        <div className="chart-header"><div><h2>Calories over time</h2></div><div className="legend"><span><i className="actual" /> Consumed</span><span><i className="target" /> Target</span></div></div>
      ...
      <div className="progress-lower">
        <section className="chart-card macro-average"><div className="chart-header"><div><h2>Macro balance</h2></div></div>{[
